...
function optionsframework_options() {
	...
	$options[] = array( "name" => "Search bar",
						"desc" => "Show search bar in header",
						"id" => "search_bar",
						"std" => "",
						"type" => "checkbox");
	...
	$options[] = array( "name" => "Site name",
						"desc" => "Check to show the site name in the header",
						"id" => "site_name",
						"std" => "1",
						"type" => "checkbox");
	...
	$options[] = array( "name" => "Theme Options",
						"desc" => "Use a custom theme. Note: This may override other styles set in the theme options panel.",
