...
function bones_register_sidebars() {
    register_sidebar(array(
    	...
    	'after_widget' => '</div>',
    	'before_title' => '<h4 class="widgettitle widgettitle-right">',
    	'after_title' => '</h4><div id="triShell"><span id="triRight"></span><div class="clearfix"></div></div>',
    ));
    
    register_sidebar(array(
    	'id' => 'sidebar2',
    	'name' => 'Post Small Sidebar',
    	'description' => 'Displays in a narrow column on the left on posts.',
    	'before_widget' => '<div id="%1$s" class="widget %2$s">',
    	'after_widget' => '</div>',
    	'before_title' => '<h4 class="widgettitle widgettitle-left">',
    	'after_title' => '</h4><div id="triShell"><span id="triLeft"></span><div class="clearfix"></div></div>',
    ));
    ...
    register_sidebar(array(
      ...
      'after_title' => '</h4><div style="margin-top:20px;"></div>',
    ));
